...
По схеме ниже можно увидеть какие блоки вызываются во время включения контроллера. **STARTUP** режим вызывается единожды во время включения контроллера, после этого исполняются блоки режима **RUN**.

<figure><img src="../../../../.gitbook/assets/TIA_S7cycle.png" alt=""><figcaption></figcaption></figure>
