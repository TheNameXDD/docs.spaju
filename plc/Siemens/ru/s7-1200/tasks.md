...
**Условие:** с помощью таймеров (разрешено только TON / OFF) сделать мигание лампочки (с частотой 0.5Hz). Мигание лампочки должно происходить коротком нажатии на кнопку S1, при коротком нажатии S2 мигание останавливается и лампочка остается просто гореть. При коротком нажатии кнопки S3 лампочка полностью выключается.&#x20;
...
## Задание 14 (Водонапорная станция)
