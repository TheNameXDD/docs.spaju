...
**Условие:** с помощью таймеров (разрешено только TON / OFF) сделать мигание лампочки (с частотой 1 Hz). Мигание лампочки должно происходить коротком нажатии на кнопку S1, при коротком нажатии S2 мигание останавливается и лампочка остается просто гореть. При коротком нажатии кнопки S3 лампочка полностью выключается.&#x20;

Дополнительное условие: если лампочка просто горит (при нажатии S2), то использовать кнопку S1 уже нельзя, только после нажатия кнопки S
...
## Задание 17 (Управление лампочками с помощью таймера)
...
## Задание 25 (HMI панель и лампочка)
